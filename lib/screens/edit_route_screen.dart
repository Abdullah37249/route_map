...
//                                   value, _cityController.text, _dateController.text),
//                             ),
//                           ),
//                           SizedBox(width: 12),
//                           Expanded(
...
//                               ),
//                               onChanged: (value) => _viewModel.updateRouteInfo(
//                                   _provinceController.text, value, _dateController.text),
//                             ),
//                           ),
//                         ],
//                       ),
...
//             onPressed: _updateToServer,
//             icon: Icon(_viewModel.existsOnServer ? Icons.cloud_sync : Icons.cloud_upload),
//             label: Text(_viewModel.existsOnServer ? 'Update Server' : 'Send to Server'),
//             backgroundColor: _viewModel.existsOnServer ? Colors.orange : Colors.green,
//             foregroundColor: Colors.white,
//             heroTag: 'server_button',
//           ),
//           SizedBox(height: 12),
//           FloatingActionButton.extended(
//             onPressed: _openMapForCompleteEdit,
//             icon: Icon(Icons.map),
